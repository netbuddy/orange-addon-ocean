...
PACKAGE_DATA = {
    'orangecontrib.ocean': ['tutorials/*.ows'],
    'orangecontrib.ocean.widgets': ['icons/*'],
}
...
ENTRY_POINTS = {
    ...
    'orange.widgets.tutorials': (
        ...
        'exampletutorials = orangecontrib.ocean.tutorials',
    ),
    ...
    "orange.canvas.help": (
        'html-index = orangecontrib.ocean.widgets:WIDGET_HELP_PATH',)
}
